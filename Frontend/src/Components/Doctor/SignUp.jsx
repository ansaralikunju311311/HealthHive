...
const SignUp = () => {
    ...
    const handleImageUpload = async (file, type) => {
        ...
        formData.append("cloud_name", "YOUR_CLOUD_NAME") // Cloudinary cloud name
        ...
        if (type === 'license') {
            ...
            setIdProofPreview(data.secure_url)
        }
    }
    ...
    return (
        <div className="container mx-auto p-8">
            <div className="max-w-3xl mx-auto bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl">
                <h2 className="text-2xl font-bold text-white mb-6">Doctor Sign-Up</h2>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    {...register("password", {
                                        ...
                                        maxLength: { value: 20, message: "Password cannot be longer than 20 characters" }
                                    })}
                                />
                                {errors.password && <p className="text-red-500">{errors.password.message}</p>}
                            </div>
